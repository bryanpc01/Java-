...
import java.io.*;
 /**
     * drawBoxBryan() draws a row x col box of asterisks
...
public class BoxBryan {
    ...
    public void drawBoxBryan (int row, int col) {
        for (int k = 0; k < row; k++) {
            for (int j = 0;j < col; j++)
                System.out.print('*');
            System.out.println();
    ...
    public static void main(String args[]) throws IOException{
        ...
        KeyboardReaderBryan input = new KeyboardReaderBryan();

        BoxBryan Box1 = new BoxBryan();
        
        System.out.print("Enter the number of rows you want in your box: ");
        nRows = input.getKeyboardIntegerRange(1,10);
        System.out.print("Enter the number of colums you want in your box: ");
        nColumns =  input.getKeyboardIntegerRange(1,10);
        System.out.println("This is what your box looks like\n");
        Box1.drawBoxBryan(nRows, nColumns);
